      ...
      <div className="container mx-auto px-4 py-6 relative z-10 max-w-2xl prose prose-sm dark:prose-invert">
        <div className="space-y-6 text-gray-700 dark:text-gray-300">
          ...
          <section>
            ...
            <p className="text-sm leading-relaxed">
              Your information may be transferred to, stored in, and processed in countries other than your country of residence. These countries may have data protection laws that differ from your home country. By using PRO BRAND WORKS, you consent to such transfers.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-sm leading-relaxed">
              We may update this Privacy Policy from time to time. We will notify you of significant changes by updating the "Last Updated" date and posting the revised policy on our platform. Your continued use of PRO BRAND WORKS following the posting of revised Privacy Policy means that you accept and agree to the changes.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="bg-purple-50/50 dark:bg-purple-900/20 border border-purple-200/50 dark:border-purple-700/50 rounded-lg p-4 text-sm mt-3 space-y-3">
              <div className="flex flex-col gap-1">
                ...
                <p className="text-gray-700 dark:text-gray-300 ml-2">Support@prodigitalbrand.com</p>
              </div>
              <div className="flex flex-col gap-1">
                <strong className="text-gray-900 dark:text-white">Phone:</strong>
                <p className="text-gray-700 dark:text-gray-300 ml-2">+17198864637</p>
              </div>
              <div className="flex flex-col gap-1">
                <strong className="text-gray-900 dark:text-white">Address:</strong>
                <p className="text-gray-700 dark:text-gray-300 ml-2">PRO BRAND WORKS LLC</p>
              </div>
            </div>
          </section>
          ...
          <section className="bg-yellow-50/50 dark:bg-yellow-900/20 border border-yellow-200/50 dark:border-yellow-700/50 rounded-lg p-4 mt-6">
            ...
            <p className="text-sm text-yellow-900 dark:text-yellow-200">
              This Privacy Policy complies with applicable data protection regulations including GDPR, CCPA, and other international privacy laws. By using PRO BRAND WORKS, you acknowledge that you have read and agree to this Privacy Policy.
            </p>
          </section>
