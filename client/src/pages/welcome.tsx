      ...
      <div className="lg:hidden px-3 sm:px-4 md:px-6 flex flex-col justify-between min-h-screen relative z-10 max-w-sm sm:max-w-md mx-auto safe-area-inset">
              ...
              <div className="relative z-10 h-full flex flex-col justify-between">
                ...
                <div className="flex justify-between items-start">
                  <div className="font-bold text-sm sm:text-base tracking-wide">
                    <span className="text-red-300">PROBRANDIFY</span>
                  </div>
        ...
        <div className="w-full pb-3 sm:pb-4">
          ...
          <div className="flex items-center justify-center gap-2 sm:gap-3 flex-wrap text-xs sm:text-sm text-red-600 dark:text-red-400 pt-3">
            ...
            <Link href="/privacy-policy" className="hover:text-red-800 dark:hover:text-red-300 transition-colors flex items-center gap-1">
